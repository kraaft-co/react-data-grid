...
var css_248z$d = ".rnvodz5700-beta7{--color:#000;--border-color:#ddd;--summary-border-color:#aaa;--background-color:#fff;--header-background-color:#f9f9f9;--row-hover-background-color:#f5f5f5;--row-selected-background-color:#dbecfa;--row-selected-hover-background-color:#c9e3f8;--checkbox-color:#005194;--checkbox-focus-color:#61b8ff;--checkbox-disabled-border-color:#ccc;--checkbox-disabled-background-color:#ddd;--selection-color:#66afe9;--font-size:14px;content-visibility:auto;background-color:var(--background-color);border:1px solid var(--border-color);box-sizing:border-box;color:var(--color);color-scheme:var(--color-scheme,light dark);contain:strict;contain:size layout style paint;direction:ltr;font-size:var(--font-size);height:350px;overflow:auto;user-select:none}@supports not (contain:strict){.rnvodz5700-beta7{position:relative;z-index:0}}.rnvodz5700-beta7 *,.rnvodz5700-beta7 :after,.rnvodz5700-beta7 :before{box-sizing:inherit}.rnvodz5700-beta7.rdg-dark{--color-scheme:dark;--color:#ddd;--border-color:#444;--summary-border-color:#555;--background-color:#212121;--header-background-color:#1b1b1b;--row-hover-background-color:#171717;--row-selected-background-color:#1a73bc;--row-selected-hover-background-color:#1768ab;--checkbox-color:#94cfff;--checkbox-focus-color:#c7e6ff;--checkbox-disabled-border-color:#000;--checkbox-disabled-background-color:#333}.rnvodz5700-beta7.rdg-light{--color-scheme:light}@media (prefers-color-scheme:dark){.rnvodz5700-beta7:not(.rdg-light){--color:#ddd;--border-color:#444;--summary-border-color:#555;--background-color:#212121;--header-background-color:#1b1b1b;--row-hover-background-color:#171717;--row-selected-background-color:#1a73bc;--row-selected-hover-background-color:#1768ab;--checkbox-color:#94cfff;--checkbox-focus-color:#c7e6ff;--checkbox-disabled-border-color:#000;--checkbox-disabled-background-color:#333}}.vlqv91k700-beta7.r1upfr80700-beta7{cursor:move}";
...
var css_248z$a = ".g1vzro7t700-beta7{outline:none}.c1fsqdic700-beta7{stroke:currentColor;stroke-width:1.5px;fill:transparent;margin-left:4px;vertical-align:middle}.c1fsqdic700-beta7>path{transition:d .1s}";
...
var css_248z$9 = ".r1v67ork700-beta7{outline:none}.r1v67ork700-beta7:after{box-shadow:inset 0 0 0 2px var(--selection-color);content:\"\";inset:0;pointer-events:none;position:absolute;z-index:2}.r1v67ork700-beta7>.cj343x0700-beta7:first-child{box-shadow:inset 2px 0 0 0 var(--selection-color)}";
...
var css_248z$8 = ".h1j9yp5q700-beta7{cursor:pointer;display:flex}.h1j9yp5q700-beta7:focus{outline:none}.h1e6at1o700-beta7{flex-grow:1;overflow:hidden;overflow:clip;text-overflow:ellipsis}.a1t8izji700-beta7{fill:currentColor}.a1t8izji700-beta7>path{transition:d .1s}";
...
var css_248z$7 = ".c6l2wv1700-beta7{touch-action:none}.c6l2wv1700-beta7:after{bottom:0;content:\"\";cursor:col-resize;position:absolute;right:0;top:0;width:10px}";
...
var css_248z$5 = ".c6ra8a3700-beta7,.cq910m0700-beta7{background-color:#ccf}.cq910m0700-beta7.c6ra8a3700-beta7{background-color:#99f}";
...
function DataGrid({
  ...
  function getCellEditor(rowIdx) {
    ...
    if (!isGroupRow(rows[selectedPosition.rowIdx]) && shouldCloseEdior != null && shouldCloseEdior(column, selectedPosition.originalRow, rows[selectedPosition.rowIdx])) {
      closeEditor();
    }
